    ...
    def _create_default_legal_data(self, countries: list) -> pd.DataFrame:
        ...
        default_legal = {
            'Germany': {
                ...
                'minimum_wage': 12.41,
                'tax_rate': 30,
                'benefits': ['Health Insurance', 'Pension', 'Unemployment Insurance', 'Paid Leave']
            },
            'Hungary': {
                'working_hours_per_week': 40,
                'vacation_days': 25,
                'minimum_wage': 8.5,
                'tax_rate': 15,
                'benefits': ['Health Insurance', 'Pension', 'Maternity Leave']
            },
            'Poland': {
                'working_hours_per_week': 40,
                'vacation_days': 26,
                'minimum_wage': 10.5,
                'tax_rate': 24,
                'benefits': ['Health Insurance', 'Pension', 'Paid Leave', 'Sick Leave']
            },
            'India': {
                ...
                'minimum_wage': 2.5,
                'tax_rate': 20,
                'benefits': ['Provident Fund', 'Gratuity', 'Medical Benefits']
            }
        }
